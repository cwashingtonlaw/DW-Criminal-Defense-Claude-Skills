# Module G — Special Verdict Forms

This reference contains the unanimity framework, special verdict form
template, and verdict form drafting considerations. It is loaded by
`dw-jury-instructions-builder` when Module G executes.
