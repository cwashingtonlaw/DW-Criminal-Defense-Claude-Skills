# Module A — Charge-Specific Element Instructions

This reference contains the full process, instruction template, and Louisiana
distinctions for drafting charge-specific element instructions. It is loaded
by `dw-jury-instructions-builder` when Module A executes.
