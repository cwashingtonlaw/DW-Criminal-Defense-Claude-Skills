...
|---|---|---|
| `dw-suppression-motion` (4th Amdt) | Warrant requirements, probable cause, good faith exception, fruit of poisonous tree | Rarely |
| `dw-suppression-motion` (5th Amdt) | Miranda, voluntariness, custody analysis, invocation of rights | Yes — false confession research, interrogation psychology |
| `dw-404b-opposition` | Prieur notice requirements, Art. 404(B) exceptions, balancing test, limiting instructions | No |
| `dw-bond-and-release-motion` | Art. 316/341 factors, excessive bail, pretrial detention conditions | Sometimes — risk assessment validity |
| `dw-sentencing-mitigation-specialist` | Art. 894.1 factors, Dorthey, excessive sentence jurisprudence, youthful offender | Yes — rehabilitation, brain development, trauma |
| `dw-expert-witness-evaluator` | Daubert/Foret reliability factors, Art. 702, specific methodology challenges | Yes — methodology validity studies |
| `dw-eyewitness-identification-auditor` | Manson/Neil v. Biggers factors, Henderson framework, suggestive procedures | Yes — eyewitness reliability research |
| `dw-habitual-offender-auditor` | Art. 529.1, predicate validity, Boykin requirements, cleansing period | No |
| `dw-pretrial-motion-library` | Varies by motion type — speedy trial (Barker), severance, venue, compel discovery | Rarely |
| `dw-jury-instructions-builder` | Responsive verdicts, lesser included offenses, self-defense, specific intent | No |
