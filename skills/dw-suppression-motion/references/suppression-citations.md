...
**For use by `dw-suppression-motion`. Internal reference. Cite-check before filing.**
...
- See `dw-confession-interrogation-auditor/references/` for the firm's full technique-analysis reference if available.
