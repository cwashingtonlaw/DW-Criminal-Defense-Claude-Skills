...
|-------|------------------|
| `dw-criminal-defense` | Phase 2 Report 3 (Red Flags) may identify 404(b) issues |
| `dw-suppression-motion` | If 404(b) evidence was obtained through a constitutional violation, suppression is the primary remedy; 404(b) exclusion is an alternative |
