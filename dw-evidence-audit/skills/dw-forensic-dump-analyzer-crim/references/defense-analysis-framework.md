...
**IMPORTANT: This skill performs initial extraction and organization of location data only. All deep analysis — tower coverage, RF propagation, directional antenna challenges, Carpenter issues — is handled by dw-cell-site-geolocation-auditor-crim.**
...
- **Hand off authentication challenges to dw-social-media-auditor-crim**
...
*This reference is loaded by the dw-forensic-dump-analyzer-crim skill during Step 3 analysis. Each section corresponds to a data category in the extraction and provides the detailed checklist for all eight defense lenses.*
