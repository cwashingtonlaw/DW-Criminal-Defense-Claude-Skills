...
**Handoff:** If cell tower data, geofence warrants, or CSLI is involved → dw-cell-site-geolocation-auditor-crim
...
- dw-mobile-forensic-auditor-crim (extraction methodology issues)
- dw-cross-exam-architect-crim (cross-exam seeds for LE, victims, witnesses)
- dw-brady-giglio-auditor-crim (disclosure obligations)
- dw-404b-opposition-crim (if ANY adverse data could trigger 404(b) notice)
- dw-suppression-motion-crim (if search warrant issues exist)
- dw-sqlite-recovery-crim (if deleted databases identified)
- dw-sex-offense-specialist-crim (if sex offense charges — strategy, jury selection, expert retention)
- dw-criminal-defense-crim (Phase 1 Step 3, Refresh Mode — if LWOP exposure on any count and `000 - Case Profile.docx` already exists)
- dw-child-forensic-interview-auditor-crim (if child victim forensic interview exists)
- dw-search-warrant-auditor (if search warrant in case)
- dw-video-evidence-auditor-crim (if body cam, dash cam, or surveillance video — NOT phone-recorded video, which stays in this analysis)
...
|---|-------------|-------|-------------|----------|--------|
| R-1 | Mobile Forensic Methodology Audit | dw-mobile-forensic-auditor-crim | This report + extraction files | HIGH | Pending |
| R-2 | Cross-Examination Outlines | dw-cross-exam-architect-crim | This report + case documents | HIGH | Pending |
| R-3 | Brady/Giglio Compliance Audit | dw-brady-giglio-auditor-crim | This report + discovery index | HIGH | Pending |
| R-4 | 404(b) Opposition Brief | dw-404b-opposition-crim | This report Section 16 adverse data | HIGH | Pending |
| R-5 | Forensic Interview Protocol Audit | dw-child-forensic-interview-auditor-crim | Forensic interview recording | HIGH | Pending |
| R-6 | Search Warrant Audit | dw-search-warrant-auditor | Search warrants (003/004) | MODERATE | Pending |
| R-7 | SQLite Database Recovery | dw-sqlite-recovery-crim | Raw extraction databases | MODERATE | Pending |
| R-8 | Sex Offense Defense Strategy | dw-sex-offense-specialist-crim | This report + all case documents | HIGH | Pending |
| R-9 | LWOP Defense Checklist | dw-criminal-defense-crim (Phase 1 Step 3 Refresh Mode) | This report + client history | HIGH | Pending |
| R-10 | Suppression Motion | dw-suppression-motion-crim | Search warrants + this report | MODERATE | Pending |
