...
When the audit identifies significant deficiencies, auto-generate cross-examination chapter seeds formatted for the **dw-cross-exam-architect** skill.
...
If extraction methodology issues are found, offer to route to dw-suppression-motion for a motion to suppress digital evidence. If the extraction passes audit, offer to route to dw-forensic-dump-analyzer to mine the contents for defense intelligence.
