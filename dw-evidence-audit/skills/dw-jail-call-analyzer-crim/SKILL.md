...
### G.4 Cross-Feed to `dw-cross-exam-architect-crim`

Module G output exports directly to `dw-cross-exam-architect-crim` as a "Defendant Self-Cross Outline" if the attorney elects testimony. The architect skill will integrate Module G admissions with the broader trial cross-examination ecosystem.
