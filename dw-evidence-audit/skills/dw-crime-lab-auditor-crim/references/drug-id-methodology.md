...
This reference is loaded by `dw-crime-lab-auditor-crim` Module A. It addresses the chemistry of controlled-substance identification — presumptive screening, confirmatory analysis, instrumental methods, bulk sampling, and the legal standards (Daubert/Foret) for sufficiency of identification.
