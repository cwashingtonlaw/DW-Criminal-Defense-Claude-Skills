...
description: >
  ...
  Do NOT use for adult interrogations — use dw-confession-interrogation-auditor-crim.
---
...
Apply attorney work-product marking per `dw-shared-protocols-crim/references/attorney-work-product-marking.md`. Include the case caption, audit date, and overall severity rating in the header.
...
If protocol deviations are found, offer to route to dw-expert-witness-evaluator-crim for a forensic interview expert (Daubert/Foret challenge). If the interview reveals suggestibility issues, flag for dw-sex-offense-specialist-crim if the case involves sex offense charges.
...
1. **Append to COMPANION SKILL OUTPUTS** in the Case Brain:
   - Skill: `dw-child-forensic-interview-auditor-crim`
