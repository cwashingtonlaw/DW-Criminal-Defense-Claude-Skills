...
This reference covers the deliverable format for the Forensic Interview Audit (Word .docx export), the severity classification system used to rate findings, and the cross-examination seed format that feeds `dw-cross-exam-architect-crim`.
...
### **Cross-Examination Seeds for dw-cross-exam-architect-crim**
