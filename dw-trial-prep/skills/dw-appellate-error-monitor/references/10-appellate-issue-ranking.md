...
This module synthesizes the findings from all prior modules into a ranked list of appellate issues, organized by likelihood of success. **The ranked-issue output produced by this module is consumed by `dw-appellate-brief-builder`.** Preserve the schema below.
