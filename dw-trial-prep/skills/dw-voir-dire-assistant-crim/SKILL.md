...
15. **Witness List:** Names of all witnesses -- cross-referenced against juror connections. If the Master Witness Table (5-column format from dw-criminal-defense-crim Phase 2 Report 8) is available, use it as the primary witness reference. The Witness Table provides name/contact info, witness type, association with case, source documents, and trial exam status — all of which inform relationship screening and witness-specific voir dire questions under Art. 797(1) and Art. 798(3).
