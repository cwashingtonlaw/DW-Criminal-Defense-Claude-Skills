# Anders Brief Trigger Analysis & Writ Application Framework (Reference)

This reference covers two specialized appellate frameworks: (1) the Anders brief assessment for appointed counsel evaluating no-merit appeals, and (2) the supervisory writ application framework for interlocutory pretrial review.
