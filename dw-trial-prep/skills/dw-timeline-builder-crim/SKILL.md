...
### 1. Load Case Context
- Invoke dw-case-brain-crim to load current case folder and prior timeline state
...
- **DMAR Reports** — from dw-transcript-router-crim pipeline output
...
- dw-case-brain-crim (current case context)
...
**Feeds Into:**
- dw-cross-exam-architect-crim (for impeachment planning)
- dw-pretrial-motion-library-crim (for suppression/Giglio motions)
- dw-trial-notebook-builder-crim (for trial chronology exhibits)
- dw-discovery-compliance-monitor-crim (for discovery response)
