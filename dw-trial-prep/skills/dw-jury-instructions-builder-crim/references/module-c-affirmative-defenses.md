# Module C — Affirmative Defense Instructions

This reference contains the full text of all ten Louisiana affirmative-defense
jury instructions and supporting case-law notes. It is loaded by
`dw-jury-instructions-builder-crim` when Module C executes.
