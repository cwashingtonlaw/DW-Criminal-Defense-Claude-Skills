# Module H — Objection Preservation

This reference contains the Louisiana objection framework, objection
template, proffer template, and charge-conference preparation checklist.
It is loaded by `dw-jury-instructions-builder-crim` when Module H executes.
