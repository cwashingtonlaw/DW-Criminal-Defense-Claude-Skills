# Module E — Witness Credibility Instructions

This reference contains the full text of all witness-credibility jury
instructions: general credibility, accomplice/cooperating witness, informant,
expert witness, and prior inconsistent statement. It is loaded by
`dw-jury-instructions-builder-crim` when Module E executes.
