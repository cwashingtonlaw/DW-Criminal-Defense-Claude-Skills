# Module F — Evidence Instructions

This reference contains the full text of evidence-specific jury instructions:
circumstantial evidence (La. R.S. 15:438), eyewitness identification,
confession voluntariness, and the prior-bad-acts limiting instruction
(La. C.E. Art. 404(B)). It is loaded by `dw-jury-instructions-builder-crim` when
Module F executes.
