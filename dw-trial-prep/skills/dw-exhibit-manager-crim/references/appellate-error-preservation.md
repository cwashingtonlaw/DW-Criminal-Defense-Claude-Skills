...
Every excluded exhibit and every sustained objection must be flagged to **dw-appellate-error-monitor-crim** with:
...
**Automatic Feed:** Every sustained objection to Defense exhibit or every State exhibit admitted over Defense objection should trigger dw-appellate-error-monitor-crim entry.
