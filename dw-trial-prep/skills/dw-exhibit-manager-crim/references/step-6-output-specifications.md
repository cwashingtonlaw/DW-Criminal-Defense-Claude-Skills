...
Filter for "Appeal Flag: YES" to generate the list for dw-appellate-error-monitor-crim.
...
Use dw-cross-exam-architect-crim output to identify cross-examination vulnerabilities.
