...
description: >
  ...
  Analyzes Art. 316/341 factors. Read ../../../dw-core/skills/dw-shared-protocols/references/template-selection-protocol.md before
  drafting.
---
...
Generate a short-form Motion (2-3 pages) using the `docx` skill conventions. Filed pleadings get caption, signature, certificate of service, and (when applicable) notice of hearing and proposed order per `dw-shared-protocols`. Do not apply attorney-work-product marking to filed pleadings.
