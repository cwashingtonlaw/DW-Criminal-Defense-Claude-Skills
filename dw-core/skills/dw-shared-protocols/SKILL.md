...
When a consuming skill reads this protocol, it should already have these variables resolved from `dw-case-brain` (v3.3+) before applying any caption or signature template:
