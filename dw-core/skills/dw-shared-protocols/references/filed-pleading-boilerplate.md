...
Confirm all of the following are resolved from `dw-case-brain` (v3.3+) BEFORE drafting:
...
1. `dw-shared-protocols/references/filed-pleading-boilerplate.md` (this file — orchestration)
