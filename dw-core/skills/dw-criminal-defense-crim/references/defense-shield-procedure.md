...
- Route jury instruction research and drafting to **dw-jury-instructions-builder-crim** for comprehensive instruction set
- Route voir dire strategy to **dw-voir-dire-assistant-crim** for juror challenge guidance
