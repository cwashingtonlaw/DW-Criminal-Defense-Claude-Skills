...
**Version 1.1 | Internal Reference Protocol**
**Attorney Work Product | Confidential**

> **This file is a shared reference, not a skill.** It lives at `references/template-selection-protocol.md`
> and is read by pleading-drafting skills before they begin drafting. It was formerly the standalone
> skill `dw-template-selector`. Any pleading skill whose SKILL.md says to read this protocol should
> read this file directly from the references folder.
...
When a D&W skill reads this protocol, it must:
...
| Skill | Motion Type |
|-------|-------------|
| `dw-suppression-motion-crim` | Suppression / Fourth and Fifth Amendment |
| `dw-pretrial-motion-library-crim` | Speedy trial, bill of particulars, continuance, compel, severance, venue, recusal, quash, competency, reveal the deal |
| `dw-bond-and-release-motion-crim` | Bond reduction / pretrial release / PR bond |
| `dw-404b-opposition-crim` | Opposition to Prieur / 404(b) notice |
| `dw-sentencing-mitigation-specialist-crim` | Sentencing memorandum / mitigation |
| `dw-video-evidence-auditor-crim` | Video evidence audit report (template selection for report output) |
