...
**Reference for:** dw-mobile-forensic-auditor-crim, dw-forensic-dump-analyzer-crim, dw-sqlite-recovery-crim
...
- **dw-mobile-forensic-auditor-crim:** Use this registry to audit extraction methodology and challenge tool reliability
- **dw-forensic-dump-analyzer-crim:** Cross-reference artifact parsing assumptions against known tool limitations
- **dw-sqlite-recovery-crim:** Verify database recovery claims against this registry's guidance on SQLite reliability
