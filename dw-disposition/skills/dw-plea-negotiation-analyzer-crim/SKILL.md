...
|---|---|---|
| **Date of offense (per count)** — fixes which version of La. R.S. 15:529.1 / 15:571.3 / 15:574.4 applies; select per `dw-shared-protocols-crim/references/sentencing-statute-versions.md` before any exposure math | Bill of information / charging docs | |
