...
When Critical violations are identified, route to the appropriate motion skill (**dw-pretrial-motion-library-crim** for Motion to Compel / "Reveal the Deal"; **dw-suppression-motion-crim** for CI-tainted evidence):
...
2. **Suppression Opportunities:** If a CI taints evidence or an undisclosed deal undermines witness credibility, identify suppression opportunities and route to **dw-suppression-motion-crim**.
