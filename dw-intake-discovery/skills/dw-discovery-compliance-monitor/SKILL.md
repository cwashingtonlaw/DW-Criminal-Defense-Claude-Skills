...
The Prioritized Missing Items Report feeds directly into **dw-criminal-defense** Phase 2 Report 7 (Table of Missing Discovery) and triggers the Auto-Action Missing Discovery Demand Letter. Route CRITICAL items immediately to **dw-brady-giglio-auditor**.
...
For deeper Brady/Giglio analysis beyond ledger maintenance, hand off to **dw-brady-giglio-auditor**.
...
- **dw-brady-giglio-auditor** — receives CRITICAL Brady/Giglio items for deeper analysis
