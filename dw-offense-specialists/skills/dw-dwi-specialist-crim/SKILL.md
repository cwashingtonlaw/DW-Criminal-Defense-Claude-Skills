...
description: >
  ...
  Do NOT use for general traffic offenses or vehicular homicide (use dw-criminal-defense-crim Phase 1).
---
...
- Route to dw-suppression-motion-crim for Fourth Amendment challenge
...
- Route to dw-confession-interrogation-auditor-crim if interrogation occurred
...
- Route to dw-suppression-motion-crim for checkpoint challenge

**Video preservation:**
- Was dash cam/BWC preserved? Deleted? Poor quality?
- Route to dw-video-evidence-auditor-crim for video analysis
...
**Reads from:**
- dw-case-brain-crim (prior convictions, case details)
- dw-case-dashboard-crim (case status)
- dw-video-evidence-auditor-crim (BWC analysis of SFST and arrest)

**Routes to:**
- dw-suppression-motion-crim (traffic stop/arrest/checkpoint challenges)
- dw-expert-witness-evaluator-crim (toxicology/forensics experts)
- dw-plea-negotiation-analyzer-crim (reduced charge negotiations)
- dw-sentencing-mitigation-specialist-crim (if conviction results)
- dw-cross-exam-architect-crim (officer cross, toxicologist cross)
...
1. Confirm offense level and case facts with dw-case-brain-crim
...
4. If BWC available, route to dw-video-evidence-auditor-crim
...
7. Evaluate plea negotiation options via dw-plea-negotiation-analyzer-crim
