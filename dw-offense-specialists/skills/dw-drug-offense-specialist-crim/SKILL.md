...
**Action:** Route to `dw-suppression-motion-crim` with drug-specific framing. Analyze:
...
**Defense expert:** Route to dw-expert-witness-evaluator-crim to challenge drug dog reliability if needed.
